	...
	<div id="corpo">
		...
		<div id="conteudo">
			...
			<div id="miolo">
				...
				<h4>Planejamento | Cen&aacute;rio</h4>
				
				<form name="atualizar" action="relatorio.formularioCenario.logic" method="post">
					<div style="margin:25px;">
						<c:if test="${empty problema.cenario}">
						...
						<c:if test="${not empty problema.cenario}">
							${m:formatarString(problema.cenario)}
						</c:if>
