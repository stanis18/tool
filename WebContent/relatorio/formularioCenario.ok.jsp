		...
		<div id="corpo">
			...
			<div id="conteudo">
				...
				<div id="miolo">
					...
					<h1>Problema: ${problema.titulo }</h1><h4>Cen&aacute;rio | Descri&ccedil;&atilde;o</h4>
					<form name="atualizar" action="relatorio.cadastrarCenarioProblema.logic" method="post">
					<input type="hidden" name="problema.idProblema" value="${problema.idProblema }">
					<div style="margin:25px;">
				       <textarea name="problema.cenario" cols="95" style="width:500px" rows="24">${problema.cenario}</textarea>
				       <br><br>
