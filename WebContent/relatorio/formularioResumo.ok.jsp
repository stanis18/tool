		...
		<div id="corpo">
			...
			<div id="conteudo">
				...
				<div id="miolo">
					...
					<form name="atualizar" action="relatorio.cadastrarResumoProblema.logic" method="post">
					<input type="hidden" name="problema.idProblema" value="${problema.idProblema }">
					<div style="margin:25px;">
				       <textarea name="problema.resumo" cols="95" rows="24" style="width:500px">${problema.resumo}</textarea>
				       <br><br>
